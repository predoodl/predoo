...
def getMaxdiff(x,csv_writer,j):
    ...
    out_32_16_1 = tf_Norm_16(x_32)
    out_64_16_1 = tf_Norm_16(x_64)
...
if __name__=='__main__':
    ...
    # Max_guided(corpus,"E:\Dtype_test\Max_guided2\\tf_cpu_2.0.0\\tf_Norm.csv", "E:\Dtype_test\Max_guided2\\tf_cpu_2.0.0\\tf_Norm_count.csv")
    # Mean_guided(corpus,"E:\Dtype_test\Mean_guided2\\tf_cpu_2.0.0\\tf_Norm.csv", "E:\Dtype_test\Mean_guided2\\tf_cpu_2.0.0\\tf_Norm_count.csv")

    Max_guided(corpus,"/home/ise/opTest/data/Max_guided2/tf_gpu_2.0.0/Norm.csv","/home/ise/opTest/data/Max_guided2/tf_gpu_2.0.0/Norm_count.csv")
    Mean_guided(corpus,"/home/ise/opTest/data/Mean_guided2/tf_gpu_2.0.0/Norm.csv","/home/ise/opTest/data/Mean_guided2/tf_gpu_2.0.0/Norm_count.csv")